...
internal class MotivoNaoVenda : Principal
{
	...
	protected override void OnStart(string[] args)
	{
		...
		{
			EventLog.WriteEntry(ex.Source + " MotivoNaoVenda", ex.Message, EventLogEntryType.Error);
			throw ex;
		}
	}
	...
	public void Action()
	{
		...
		{
			ConfiguraSincroniza();
			Sincroniza.ImportaMotivoNaoVenda();
		}
		catch (Exception ex)
		{
			EventLog.WriteEntry(ex.Source + " MotivoNaoVenda", ex.Message, EventLogEntryType.Error);
	...
	private void InitializeComponent()
	{
		...
		base.ServiceName = "MotivoNaoVenda";
	}
}
