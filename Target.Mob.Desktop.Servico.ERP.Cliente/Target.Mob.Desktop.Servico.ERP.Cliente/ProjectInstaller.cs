...
public class ProjectInstaller : Installer
{
	...
	private ServiceInstaller Cliente;
	...
	private void SetServiceName()
	{
		...
		{
			Cliente.ServiceName = base.Context.Parameters["ServiceName"];
		}
		if (base.Context.Parameters.ContainsKey("DisplayName"))
		{
			Cliente.DisplayName = base.Context.Parameters["DisplayName"];
		}
	}
	...
	private void InitializeComponent()
	{
		...
		Cliente = new ServiceInstaller();
		Instalador.Password = null;
		Instalador.Username = null;
		Cliente.Description = "Target Mob ERP - Importação de Clientes";
		Cliente.DisplayName = "Target Mob ERP - Importação de Clientes";
		Cliente.ServiceName = "Cliente";
		base.Installers.AddRange(new Installer[2] { Instalador, Cliente });
	}
}
