...
internal class Cliente : Principal
{
	...
	protected override void OnStart(string[] args)
	{
		...
		{
			EventLog.WriteEntry(ex.Source + " Cliente", ex.Message, EventLogEntryType.Error);
			throw ex;
		}
	}
