...
public class ProjectInstaller : Installer
{
	...
	private ServiceInstaller Socket;
	...
	private void SetServiceName()
	{
		...
		{
			Socket.ServiceName = base.Context.Parameters["ServiceName"];
		}
		if (base.Context.Parameters.ContainsKey("DisplayName"))
		{
			Socket.DisplayName = base.Context.Parameters["DisplayName"];
		}
	}
	...
	private void InitializeComponent()
	{
		...
		Socket = new ServiceInstaller();
		Instalador.Password = null;
		Instalador.Username = null;
		Socket.Description = "Target Mob ERP - SocketIO";
		Socket.DisplayName = "Target Mob ERP - SocketIO";
		Socket.ServiceName = "Socket";
		base.Installers.AddRange(new Installer[2] { Instalador, Socket });
	}
}
