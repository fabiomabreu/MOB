...
internal class EmailTransfer : Principal
{
	...
	protected override void OnStart(string[] args)
	{
		...
		{
			EventLog.WriteEntry(ex.Source + " EmailTransfer", ex.Message, EventLogEntryType.Error);
			throw ex;
		}
	}
	...
	private void InitializeComponent()
	{
		...
		base.ServiceName = "EmailTransfer";
	}
}
