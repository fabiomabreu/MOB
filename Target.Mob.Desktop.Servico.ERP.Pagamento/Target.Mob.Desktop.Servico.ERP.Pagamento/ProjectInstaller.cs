...
public class ProjectInstaller : Installer
{
	...
	private ServiceInstaller Pagamento;
	...
	private void SetServiceName()
	{
		...
		{
			Pagamento.ServiceName = base.Context.Parameters["ServiceName"];
		}
		if (base.Context.Parameters.ContainsKey("DisplayName"))
		{
			Pagamento.DisplayName = base.Context.Parameters["DisplayName"];
		}
	}
	...
	private void InitializeComponent()
	{
		...
		Pagamento = new ServiceInstaller();
		Instalador.Password = null;
		Instalador.Username = null;
		Pagamento.Description = "Target Mob ERP - Pagamento";
		Pagamento.DisplayName = "Target Mob ERP - Pagamento";
		Pagamento.ServiceName = "Pagamento";
		base.Installers.AddRange(new Installer[2] { Instalador, Pagamento });
	}
}
