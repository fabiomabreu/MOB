...
public class ProjectInstaller : Installer
{
	...
	private void SetServiceName()
	{
		...
		{
			Servico.ServiceName = base.Context.Parameters["ServiceName"];
		}
		if (base.Context.Parameters.ContainsKey("DisplayName"))
		{
			Servico.DisplayName = base.Context.Parameters["DisplayName"];
		}
	}
	...
	private void InitializeComponent()
	{
		...
		Servico.Description = "Target Mob ERP - Importação de Configurações dos Serviços";
		Servico.DisplayName = "Target Mob ERP - Importação de Configurações dos Serviços";
		Servico.ServiceName = "Servico";
		base.Installers.AddRange(new Installer[2] { Instalador, Servico });
	}
}
