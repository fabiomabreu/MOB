...
internal class RelatorioGera : Principal
{
	private IContainer components;

	public RelatorioGera()
	{
		CodigoServico = 20;
		InitializeComponent();
	}
	...
	protected override void OnStart(string[] args)
	{
		...
		{
			EventLog.WriteEntry(ex.Source + " RelatorioGera", ex.Message, EventLogEntryType.Error);
			throw ex;
		}
	}
	...
	private void InitializeComponent()
	{
		...
		base.ServiceName = "RelatorioGera";
	}
}
