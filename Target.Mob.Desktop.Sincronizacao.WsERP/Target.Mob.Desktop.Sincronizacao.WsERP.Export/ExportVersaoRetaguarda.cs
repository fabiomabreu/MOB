...
internal class ExportVersaoRetaguarda
{
	...
	public ExportVersaoRetaguarda(string stringConnTargetErp, string cnpjEmpresa, BasicHttpBinding bindingBasicHttp, EndpointAddress remoteAddress)
	{
	...
	public void Exportar(object eventosAtivos)
	{
		...
		try
		{
			...
			RetornoWsModelOfBoolean retornoWsModelOfBoolean = wsErpSoapClient.WsERP_VersaoRetaguarda_Setar(validationSoapHeader, _CnpjEmpresa, version.Major, version.Minor, version.Build, version.Revision, Seguranca.getHostName());
