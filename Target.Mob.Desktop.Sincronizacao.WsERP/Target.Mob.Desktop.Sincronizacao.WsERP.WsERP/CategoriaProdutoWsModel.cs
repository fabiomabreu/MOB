...
public class CategoriaProdutoWsModel : INotifyPropertyChanged
{
	private int? idField;

	private string cdCategPrdField;
	...
	public string CdCategPrd
	{
		get
		{
			return cdCategPrdField;
		}
		set
		{
			cdCategPrdField = value;
			RaisePropertyChanged("CdCategPrd");
		}
	}
