...
public class RetornoWsModelOfProdutoVersaoWsModel : INotifyPropertyChanged
{
	private ProdutoVersaoWsModel retornoWsField;

	private LogErroWsModel excecaoField;

	[XmlElement(Order = 0)]
	public ProdutoVersaoWsModel RetornoWs
	{
		get
		{
