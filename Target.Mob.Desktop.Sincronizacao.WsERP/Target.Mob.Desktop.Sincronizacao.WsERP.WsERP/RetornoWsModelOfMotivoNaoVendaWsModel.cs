...
public class RetornoWsModelOfMotivoNaoVendaWsModel : INotifyPropertyChanged
{
	private MotivoNaoVendaWsModel retornoWsField;

	private LogErroWsModel excecaoField;

	[XmlElement(Order = 0)]
	public MotivoNaoVendaWsModel RetornoWs
	{
		get
		{
