...
public class RetornoWsModelOfListOfTipoGrupoSPWsModel : INotifyPropertyChanged
{
	private TipoGrupoSPWsModel[] retornoWsField;

	private LogErroWsModel excecaoField;

	[XmlArray(Order = 0)]
	public TipoGrupoSPWsModel[] RetornoWs
	{
		get
		{
