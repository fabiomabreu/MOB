...
[Serializable]
[XmlInclude(typeof(ItPedvAtendimentoModel))]
[GeneratedCode("System.Xml", "4.8.9037.0")]
[DebuggerStepThrough]
[DesignerCategory("code")]
[XmlType(Namespace = "Target.WsERP")]
public class ItPedvAtendimentoWsModel : INotifyPropertyChanged
{
	private int? iDItPedvAtendimentoField;
	...
	private decimal? vlMargemBrtCUEField;

	private decimal? vlMargemBrtCRPField;

	private decimal? vlMargemBrtCMPField;

	private decimal? vlVerbaField;

	private decimal? vlSTField;

	private decimal? vlIPIField;

	private decimal? valorVendaAVistaField;

	private int? codigoCondPgtoField;

	[XmlElement(IsNullable = true, Order = 0)]
	public int? IDItPedvAtendimento
	{
		get
		{
			return iDItPedvAtendimentoField;
		}
		set
		{
			iDItPedvAtendimentoField = value;
			RaisePropertyChanged("IDItPedvAtendimento");
		}
	}
	...
	public decimal? VlMargemBrtCUE
	{
		get
		{
			return vlMargemBrtCUEField;
		}
		set
		{
			vlMargemBrtCUEField = value;
			RaisePropertyChanged("VlMargemBrtCUE");
		}
	}

	[XmlElement(IsNullable = true, Order = 24)]
	public decimal? VlMargemBrtCRP
	{
		get
		{
			return vlMargemBrtCRPField;
		}
		set
		{
			vlMargemBrtCRPField = value;
			RaisePropertyChanged("VlMargemBrtCRP");
		}
	}

	[XmlElement(IsNullable = true, Order = 25)]
	public decimal? VlMargemBrtCMP
	{
		get
		{
			return vlMargemBrtCMPField;
		}
		set
		{
			vlMargemBrtCMPField = value;
			RaisePropertyChanged("VlMargemBrtCMP");
		}
	}
	...
	public decimal? ValorVendaAVista
	{
		get
		{
			return valorVendaAVistaField;
		}
		set
		{
			valorVendaAVistaField = value;
			RaisePropertyChanged("ValorVendaAVista");
		}
	}
