...
public class GetCrossStreetXYResponseBody
{
	[DataMember(EmitDefaultValue = false, Order = 0)]
	public CrossStreetLocation[] GetCrossStreetXYResult;

	public GetCrossStreetXYResponseBody()
	{
	}

	public GetCrossStreetXYResponseBody(CrossStreetLocation[] GetCrossStreetXYResult)
	{
