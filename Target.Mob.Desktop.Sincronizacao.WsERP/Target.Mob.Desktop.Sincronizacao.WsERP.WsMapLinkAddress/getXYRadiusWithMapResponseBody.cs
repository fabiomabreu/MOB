...
public class getXYRadiusWithMapResponseBody
{
	[DataMember(EmitDefaultValue = false, Order = 0)]
	public MapInfo getXYRadiusWithMapResult;

	public getXYRadiusWithMapResponseBody()
	{
	}

	public getXYRadiusWithMapResponseBody(MapInfo getXYRadiusWithMapResult)
	{
