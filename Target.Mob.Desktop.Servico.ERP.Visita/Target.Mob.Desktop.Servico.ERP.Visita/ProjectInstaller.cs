...
namespace Target.Mob.Desktop.Servico.ERP.Visita;
...
public class ProjectInstaller : Installer
{
	...
	private ServiceInstaller Visita;
	...
	private void SetServiceName()
	{
		...
		{
			Visita.ServiceName = base.Context.Parameters["ServiceName"];
		}
		if (base.Context.Parameters.ContainsKey("DisplayName"))
		{
			Visita.DisplayName = base.Context.Parameters["DisplayName"];
		}
	}
	...
	private void InitializeComponent()
	{
		...
		Visita = new ServiceInstaller();
		Instalador.Password = null;
		Instalador.Username = null;
		Visita.Description = "Target Mob ERP - Importação de Plano de Visitas";
		Visita.DisplayName = "Target Mob ERP - Importação de Plano de Visitas";
		Visita.ServiceName = "Visita";
		base.Installers.AddRange(new Installer[2] { Instalador, Visita });
	}
}
