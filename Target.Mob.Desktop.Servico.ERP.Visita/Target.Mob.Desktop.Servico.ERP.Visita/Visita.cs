...
internal class Visita : Principal
{
	...
	protected override void OnStart(string[] args)
	{
		...
		{
			EventLog.WriteEntry(ex.Source + " Visita", ex.Message, EventLogEntryType.Error);
			throw ex;
		}
	}
