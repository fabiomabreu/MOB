...
internal class Relatorio_Export : Principal
{
	private IContainer components;

	public Relatorio_Export()
	{
		CodigoServico = 18;
		InitializeComponent();
	}
	...
	protected override void OnStart(string[] args)
	{
		...
		{
			EventLog.WriteEntry(ex.Source + " Relatorio_Export", ex.Message, EventLogEntryType.Error);
			throw ex;
		}
	}
	...
	private void InitializeComponent()
	{
		...
		base.ServiceName = "Relatorio_Export";
	}
}
