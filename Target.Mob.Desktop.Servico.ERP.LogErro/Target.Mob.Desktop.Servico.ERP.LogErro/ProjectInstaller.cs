...
public class ProjectInstaller : Installer
{
	...
	private ServiceInstaller LogErro;
	...
	private void SetServiceName()
	{
		...
		{
			LogErro.ServiceName = base.Context.Parameters["ServiceName"];
		}
		if (base.Context.Parameters.ContainsKey("DisplayName"))
		{
			LogErro.DisplayName = base.Context.Parameters["DisplayName"];
		}
	}
	...
	private void InitializeComponent()
	{
		...
		LogErro = new ServiceInstaller();
		Instalador.Password = null;
		Instalador.Username = null;
		LogErro.Description = "Target Mob ERP - Exportação de Logs";
		LogErro.DisplayName = "Target Mob ERP - Exportação de Logs";
		LogErro.ServiceName = "LogErro";
		base.Installers.AddRange(new Installer[2] { Instalador, LogErro });
	}
}
