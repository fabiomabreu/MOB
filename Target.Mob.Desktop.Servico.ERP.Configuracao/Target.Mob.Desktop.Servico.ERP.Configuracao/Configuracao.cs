...
internal class Configuracao : Principal
{
	...
	protected override void OnStart(string[] args)
	{
		...
		{
			EventLog.WriteEntry(ex.Source + " Configuracao", ex.Message, EventLogEntryType.Error);
			throw ex;
		}
	}
	...
	public void Action()
	{
		...
		{
			ConfiguraSincroniza();
			Sincroniza.ImportaConfiguracaoVendedor();
		}
		catch (Exception ex)
		{
			EventLog.WriteEntry(ex.Source + " Configuracao", ex.Message, EventLogEntryType.Error);
