...
internal class TrabalhoVendedor : Principal
{
	private IContainer components;

	public TrabalhoVendedor()
	{
		CodigoServico = 27;
		InitializeComponent();
	}
	...
	protected override void OnStart(string[] args)
	{
		...
		{
			EventLog.WriteEntry(ex.Source + " TrabalhoVendedor", ex.Message, EventLogEntryType.Error);
			throw ex;
		}
	}
	...
	public void Action()
	{
		...
		{
			ConfiguraSincroniza();
			Sincroniza.ImportaTrabalhoVendedor();
		}
		catch (Exception ex)
		{
			EventLog.WriteEntry(ex.Source + " TrabalhoVendedor", ex.Message, EventLogEntryType.Error);
	...
	private void InitializeComponent()
	{
		...
		base.ServiceName = "TrabalhoVendedor";
	}
}
