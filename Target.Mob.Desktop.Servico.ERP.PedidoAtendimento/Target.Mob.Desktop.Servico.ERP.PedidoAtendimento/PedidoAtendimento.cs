...
internal class PedidoAtendimento : Principal
{
	...
	protected override void OnStart(string[] args)
	{
		...
		{
			EventLog.WriteEntry(ex.Source + " PedidoAtendimento", ex.Message, EventLogEntryType.Error);
			throw ex;
		}
	}
	...
	public void Action()
	{
		...
		{
			ConfiguraSincroniza();
			Sincroniza.ExportaPedidoAtendimento();
		}
		catch (Exception ex)
		{
			EventLog.WriteEntry(ex.Source + " PedidoAtendimento", ex.Message, EventLogEntryType.Error);
	...
	private void InitializeComponent()
	{
		...
		base.ServiceName = "PedidoAtendimento";
	}
}
