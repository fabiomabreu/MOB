...
internal class RelatorioConfig_Import : Principal
{
	private IContainer components;

	public RelatorioConfig_Import()
	{
		CodigoServico = 19;
		InitializeComponent();
	}
	...
	protected override void OnStart(string[] args)
	{
		...
		{
			EventLog.WriteEntry(ex.Source + " RelatorioConfig_Import", ex.Message, EventLogEntryType.Error);
			throw ex;
		}
	}
	...
	private void InitializeComponent()
	{
		...
		base.ServiceName = "RelatorioConfig_Import";
	}
}
