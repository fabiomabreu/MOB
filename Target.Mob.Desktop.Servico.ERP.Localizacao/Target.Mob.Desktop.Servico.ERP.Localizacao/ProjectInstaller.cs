...
public class ProjectInstaller : Installer
{
	...
	private ServiceInstaller Localizacao;
	...
	private void SetServiceName()
	{
		...
		{
			Localizacao.ServiceName = base.Context.Parameters["ServiceName"];
		}
		if (base.Context.Parameters.ContainsKey("DisplayName"))
		{
			Localizacao.DisplayName = base.Context.Parameters["DisplayName"];
		}
	}
	...
	private void InitializeComponent()
	{
		...
		Localizacao = new ServiceInstaller();
		Instalador.Password = null;
		Instalador.Username = null;
		Localizacao.Description = "Target Mob ERP - Atualização de Localizacao";
		Localizacao.DisplayName = "Target Mob ERP - Atualização de Localizacao";
		Localizacao.ServiceName = "Localizacao";
		base.Installers.AddRange(new Installer[2] { Instalador, Localizacao });
	}
}
