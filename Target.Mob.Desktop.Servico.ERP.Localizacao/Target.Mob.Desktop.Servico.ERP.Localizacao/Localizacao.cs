...
internal class Localizacao : Principal
{
	...
	protected override void OnStart(string[] args)
	{
		...
		{
			EventLog.WriteEntry(ex.Source + " Localizacao", ex.Message, EventLogEntryType.Error);
			throw ex;
		}
	}
	...
	public void Action()
	{
		...
		{
			ConfiguraSincroniza();
			Sincroniza.ExportaCoordenadaCliente();
		}
		catch (Exception ex)
		{
			EventLog.WriteEntry(ex.Source + " Localizacao", ex.Message, EventLogEntryType.Error);
