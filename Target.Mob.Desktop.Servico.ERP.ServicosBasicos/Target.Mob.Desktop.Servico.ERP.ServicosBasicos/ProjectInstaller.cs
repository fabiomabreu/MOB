...
public class ProjectInstaller : Installer
{
	...
	private ServiceInstaller ServicosBasicos;
	...
	private void SetServiceName()
	{
		...
		{
			ServicosBasicos.ServiceName = base.Context.Parameters["ServiceName"];
		}
		if (base.Context.Parameters.ContainsKey("DisplayName"))
		{
			ServicosBasicos.DisplayName = base.Context.Parameters["DisplayName"];
		}
	}
	...
	private void InitializeComponent()
	{
		...
		ServicosBasicos = new ServiceInstaller();
		Instalador.Password = null;
		Instalador.Username = null;
		ServicosBasicos.Description = "Target Mob ERP - Exportação de Cadastros Básicos";
		ServicosBasicos.DisplayName = "Target Mob ERP - Exportação de Cadastros Básicos";
		ServicosBasicos.ServiceName = "ServicosBasicos";
		base.Installers.AddRange(new Installer[2] { Instalador, ServicosBasicos });
	}
}
