...
internal class Notificacao : Principal
{
	...
	protected override void OnStart(string[] args)
	{
		...
		{
			EventLog.WriteEntry(ex.Source + " Notificação", ex.Message, EventLogEntryType.Error);
			throw ex;
		}
	}
