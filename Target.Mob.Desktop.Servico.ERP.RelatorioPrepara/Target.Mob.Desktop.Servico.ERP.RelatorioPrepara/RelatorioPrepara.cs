...
internal class RelatorioPrepara : Principal
{
	private IContainer components;

	public RelatorioPrepara()
	{
		CodigoServico = 17;
		InitializeComponent();
	}
	...
	protected override void OnStart(string[] args)
	{
		...
		{
			EventLog.WriteEntry(ex.Source + " RelatorioPrepara", ex.Message, EventLogEntryType.Error);
			throw ex;
		}
	}
	...
	private void InitializeComponent()
	{
		...
		base.ServiceName = "RelatorioPrepara";
	}
}
