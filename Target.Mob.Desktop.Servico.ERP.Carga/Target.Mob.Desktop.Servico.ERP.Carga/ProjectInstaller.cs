...
namespace Target.Mob.Desktop.Servico.ERP.Carga;
...
public class ProjectInstaller : Installer
{
	...
	private ServiceInstaller Carga;
	...
	private void SetServiceName()
	{
		...
		{
			Carga.ServiceName = base.Context.Parameters["ServiceName"];
		}
		if (base.Context.Parameters.ContainsKey("DisplayName"))
		{
			Carga.DisplayName = base.Context.Parameters["DisplayName"];
		}
	}
	...
	private void InitializeComponent()
	{
		...
		Carga = new ServiceInstaller();
		Instalador.Password = null;
		Instalador.Username = null;
		Carga.Description = "Target Mob ERP - Exportação de Atualização de Dados";
		Carga.DisplayName = "Target Mob ERP - Exportação de Atualização de Dados";
		Carga.ServiceName = "Carga";
		base.Installers.AddRange(new Installer[2] { Instalador, Carga });
	}
}
