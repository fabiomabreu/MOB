...
internal class GerarDados : Principal
{
	...
	protected override void OnStart(string[] args)
	{
		...
		{
			EventLog.WriteEntry(ex.Source + " GerarDados", ex.Message, EventLogEntryType.Error);
			throw ex;
		}
	}
	...
	public void Action()
	{
		...
		{
			ConfiguraSincroniza();
			Sincroniza.GeraDados(multiThread: true);
		}
		catch (Exception ex)
		{
			EventLog.WriteEntry(ex.Source + " GerarDados", ex.Message, EventLogEntryType.Error);
