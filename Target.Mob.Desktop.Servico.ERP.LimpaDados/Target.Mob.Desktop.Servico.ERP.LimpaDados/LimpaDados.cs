...
internal class LimpaDados : Principal
{
	...
	protected override void OnStart(string[] args)
	{
		...
		{
			EventLog.WriteEntry(ex.Source + " LimpaDados", ex.Message, EventLogEntryType.Error);
			throw ex;
		}
	}
