...
public class ProjectInstaller : Installer
{
	...
	private ServiceInstaller LimpaDados;
	...
	private void SetServiceName()
	{
		...
		{
			LimpaDados.ServiceName = base.Context.Parameters["ServiceName"];
		}
		if (base.Context.Parameters.ContainsKey("DisplayName"))
		{
			LimpaDados.DisplayName = base.Context.Parameters["DisplayName"];
		}
	}
	...
	private void InitializeComponent()
	{
		...
		LimpaDados = new ServiceInstaller();
		Instalador.Password = null;
		Instalador.Username = null;
		LimpaDados.Description = "Target Mob ERP - Limpa Dados";
		LimpaDados.DisplayName = "Target Mob ERP - Limpa Dados";
		LimpaDados.ServiceName = "LimpaDados";
		base.Installers.AddRange(new Installer[2] { Instalador, LimpaDados });
	}
}
