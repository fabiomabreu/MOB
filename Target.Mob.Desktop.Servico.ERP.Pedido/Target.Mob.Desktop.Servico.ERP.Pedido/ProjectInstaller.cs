...
namespace Target.Mob.Desktop.Servico.ERP.Pedido;
...
public class ProjectInstaller : Installer
{
	...
	private ServiceInstaller Pedido;
	...
	private void SetServiceName()
	{
		...
		{
			Pedido.ServiceName = base.Context.Parameters["ServiceName"];
		}
		if (base.Context.Parameters.ContainsKey("DisplayName"))
		{
			Pedido.DisplayName = base.Context.Parameters["DisplayName"];
		}
	}
	...
	private void InitializeComponent()
	{
		...
		Pedido = new ServiceInstaller();
		Instalador.Password = null;
		Instalador.Username = null;
		Pedido.DelayedAutoStart = true;
		Pedido.Description = "Target Mob ERP - Importação de Pedidos";
		Pedido.DisplayName = "Target Mob ERP - Importação de Pedidos";
		Pedido.ServiceName = "Pedido";
		base.Installers.AddRange(new Installer[2] { Instalador, Pedido });
	}
}
